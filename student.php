 ...
 <div class="container" style="width:500px; padding-top:50px;">
   <form action="result.php" method="post" onsubmit="return insertStudentAndRedirectToResult(this)">
     ...
     <div id="stud_grade_input" class="form-group">
       ...
       <input type="text" class="form-control" id="stud_grade" name="stud_grade" value="<?=$_SESSION['grade']?>">
     </div>
     ...
     <input type="submit" id="btn_submit" name="" value="제출" class="btn btn-success">
   </form>
 </div>

<script>
function insertStudentAndRedirectToResult(form){
  $.post('session/student.php',$(form).serialize(),function(jsonResult){ //jsonResult == proc/dao_result.php 에서 받아온 내용
/*
